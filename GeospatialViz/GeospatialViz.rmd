...
```{r top10,fig.width=8, echo=T}
  ...
  labs(
       ...
       caption = "Data: https://www.foreignlaborcert.doleta.gov/pdf/PerformanceData/2017/PERM_Disclosure_Data_FY17.xlsx",
...
ggplot(WageDiff,aes(map_id=fname))+
  ...
  labs(x = "", y = "",
       title="Mean Wage Difference Between Wage Rates Proposed by H-1B Dependent Employers and by H-1B Independent Employers\n for H-1B Workers in Each State of the US(2017)",
       subtitle="\nWage Difference = Wage(H-1B Dependent Employers)-Wage(H-1B Independent Employers)",
       caption="Data: https://www.foreignlaborcert.doleta.gov/pdf/PerformanceData/2017/H-1B_Disclosure_Data_FY17.xlsx")
